...
class GameRound(models.Model):
    ...
    EIGHTH = 'KO-8'
    SIXTEENTH = 'KO-16'
    THIRD_POSITION = 'POS-3'
    FIFTH_POSITION = 'POS-5'
    SIXTH_POSITION = 'POS-6'
    SEVENTH_POSITION = 'POS-7'
    EIGHTH_POSITION = 'POS-8'
    NINTH_POSITION = 'POS-9'
    TENTH_POSITION = 'POS-10'
    ELEVENTH_POSITION = 'POS-11'
    TWELFTH_POSITION = 'POS-12'
    THIRTEENTH_POSITION = 'POS-13'
    FOURTEENTH_POSITION = 'POS-14'
    FIFTEENTH_POSITION = 'POS-15'
    SIXTEENTH_POSITION = 'POS-16'
    EIGHTEENTH_POSITION = 'POS-18'
    TWENTIETH_POSITION = 'POS-20'
    DIVISION = 'Division'
    POOL_A = 'Pool-A'
    POOL_B = 'Pool-B'
    POOL_C = 'Pool-C'
