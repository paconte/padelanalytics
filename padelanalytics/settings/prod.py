...
ROOT_URLCONF = 'padelanalytics.urls'
...
STATIC_URL = '/static/padelanalytics/'
...
LOGGING = {
    ...
    'handlers': {
        'default': {
            ...
            'filename': '/home/django/logs/padel_default.log',
        ...
        'request_handler': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': '/home/django/logs/padel_request.log',
            'maxBytes': 1024*1024*5, # 5 MB
            'backupCount': 5,
            'formatter': 'standard',
                    },
